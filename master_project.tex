...
\title{ Improving dynamic allocation cluster schedulers }
...
distributed operative system has already started happening with Mesos
whose simple API has facilitated the creation of frameworks like
Aurora \cite{_apache_????-1} or Marathon
\cite{_mesosphere/marathon_????} that provide useful primitives for the
execution of applications like load balancing, interservice
communication, or automatic failover.
