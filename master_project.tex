...
%% - Big data centers
%% - + recently generalized clusters
%% - + amazon and other clouds
%% - + popularity of parallel processing frameworks
...
%% The public release of the traces of many clusters [refs] has
%% make it possible for those interested to implement cluster
%% schedulers and test them against the traces.

%% Difficulties

%% Explain quickly what are the difficulties for the implementation
%% of schedulers (can take it from the abstract of the other article):
